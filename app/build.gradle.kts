...
dependencies {
    ...
    "gmsImplementation"(libs.media3.cast); "gmsImplementation"(libs.mediarouter); "gmsImplementation"(libs.cast.framework); implementation(libs.room.runtime); implementation(libs.kuromoji.ipadic); implementation(libs.tinypinyin); ksp(libs.room.compiler); implementation(libs.room.ktx); implementation(libs.apache.lang3); implementation(libs.hilt); implementation(libs.jsoup); ksp(libs.hilt.compiler)
