...
dependencies {
    ...
    "gmsImplementation"(libs.media3.cast); "gmsImplementation"(libs.mediarouter); "gmsImplementation"(libs.cast.framework); implementation(libs.room.runtime); implementation(libs.kuromoji.ipadic); implementation("com.github.promeg:tinypinyin:c4c65b9c0c82cc8e60ef081e91f3cc66b7829dcc"); implementation("dev.ffmpegkit-maintained:ffmpeg-kit-full:8.1.7"); ksp(libs.room.compiler); implementation(libs.room.ktx); implementation(libs.apache.lang3); implementation(libs.hilt); implementation(libs.jsoup); ksp(libs.hilt.compiler)
